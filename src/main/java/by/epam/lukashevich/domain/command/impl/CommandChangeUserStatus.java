...
import static by.epam.lukashevich.domain.command.CommandName.VIEW_USER_TABLE;
...
public class CommandChangeUserStatus implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(request.getParameter("userForAction"));
        ...
        try {
            ...
            throw new CommandException("Can't update user status in CommandChangeUserBanStatus", e);
        }
    }
}
