    ...
    <form action="controller" method="post">
        ...
        <table cellspacing="2" border="1" cellpadding="5" bordercolor="gray">
            ...
            <c:forEach items="${testList}" var="test">
                <tr>
                    <td align="center" width="100"> ${test.title} </td>
                    <td align="center" width="100"> ${test.description} </td>
                    <td align="center" width="100"> ${test.subjectId} </td>
                    <td align="center" width="100"> ${test.authorId} </td>
                    <td>
                        <label>
                            <input type="radio" name="testForAction" value="${test.id}">
                        </label>
                    </td>
                </tr>
            </c:forEach>
        ...
        <button type="submit" name="command" value="viewTestEditPage">
            <strong><fmt:message key="button.edit"/></strong>
        </button>
        <button type="submit" name="command" value="deleteTest">
            <strong><fmt:message key="button.test_delete"/></strong>
        </button>
    </form>

    <a href="controller?command=viewTestAddPage">ADD TEST</a>
</div>
<hr>
<div class="footer">
